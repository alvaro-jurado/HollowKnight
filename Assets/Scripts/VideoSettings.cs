...
public class VideoSettings : MonoBehaviour
{
    ...
    {
        // Buscar índice de la resolución predeterminada
        ...
        // Si no se encuentra la resolución predeterminada, usar la primera disponible
        if (currentResolutionIndex < 0 || currentResolutionIndex >= resolutions.Length)
        {
            currentResolutionIndex = 0;
        }

        // Aplicar la resolución predeterminada
        ...
        // Actualizar el texto de la resolución en el menú
        UpdateResolutionText();
    }
